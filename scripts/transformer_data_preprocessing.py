...
EMOJI_TO_NEPALI = {
    ...
    '😬': 'तनाव', '🤨': 'शंकास्पद', '🤫': 'चुपचाप', '🤭': 'हात छोप्ने', 
    '🤥': 'झूठ', '😶': 'मौन',
...
def extract_emoji_features(text: str) -> Dict[str, int]:
    ...
    - 3 derived features (total, ratio, mixed_sentiment)
    """
...
def get_emoji_info(text: str) -> Dict[str, any]:
    """
    Get emoji analysis (useful for Streamlit display)
    
    Returns:
        Dictionary with emoji features and emojis found
    """
